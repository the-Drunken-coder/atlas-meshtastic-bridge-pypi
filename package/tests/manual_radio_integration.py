"""Manual radio script for atlas_meshtastic_bridge operators.

This file is intentionally not part of automated pytest coverage or CI.
Run it manually when validating real bridge hardware behavior with two radios.
